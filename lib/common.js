...
var ECDSA = orecore.crypto.ECDSA;
var sha256sha256 = orecore.crypto.Hash.sha256sha256;
var varintBufNum = orecore.encoding.BufferWriter.varintBufNum;

// BIP 70 - payment protocol
function PaymentProtocol(currency) {
  this.messageType = null;
  this.message = null;
  this.currency = currency || 'ORE';
}
...
PaymentProtocol.LEGACY_PAYMENT.ORE.REQUEST_CONTENT_TYPE = 'application/galactrum-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.ORE.CONTENT_TYPE = 'application/galactrum-payment';
PaymentProtocol.LEGACY_PAYMENT.ORE.ACK_CONTENT_TYPE = 'application/galactrum-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'ORE';
  this.setObj(obj);
  return this;
};
...
function magicHash(str) {
  var magicBytes = new Buffer('Galactrum Signed Message:\n');
