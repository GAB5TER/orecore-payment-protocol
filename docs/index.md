...
```
npm install orecore-lib --save
npm install orecore-payment-protocol --save
```

For client-side projects:

```
bower install orecore-lib --save
bower install orecore-payment-protocol --save
```
...
```javascript
var PaymentProtocol = require('orecore-payment-protocol');
...
// send the transaction to the galactrum network
```
